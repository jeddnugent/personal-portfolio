	...
	return (
		<>
			<div className="hero container">
				...
				<p className="hero__desc">A passionate <strong>Software Developer</strong> located in Melbourne, Australia with experience working in <strong>front-end mobile app development </strong>
